...
- Remote audit review is a workflow surface. Keep it read-only, local, and filter-based over append-only JSONL records; never re-run a tool call or infer semantic quality from the audit log.

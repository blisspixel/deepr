...
- [src-w2-provenance] Temporal axes do not replace provenance. Source identity, citations, and confidence remain required even when valid-time and transaction-time are modeled.

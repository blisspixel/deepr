...
class TestFileUploadValidation:
    ...
    def test_upload_validates_file_exists(self, runner):
        ...
        with patch("deepr.cli.commands.run.asyncio.run") as mock_run:
            ...
            result = runner.invoke(cli, ["run", "focus", "test query", "--upload", "/nonexistent/file.txt"])
...
class TestProviderValidation:
    ...
    def test_provider_option_accepts_openai(self, runner):
        ...
        with patch("deepr.cli.commands.run.asyncio.run") as mock_run:
            mock_run.return_value = None
            result = runner.invoke(cli, ["run", "focus", "test query", "--provider", "openai"])
    ...
    def test_provider_option_accepts_gemini(self, runner):
        ...
        with patch("deepr.cli.commands.run.asyncio.run") as mock_run:
            mock_run.return_value = None
            result = runner.invoke(cli, ["run", "focus", "test query", "--provider", "gemini"])
    ...
    def test_provider_option_accepts_grok(self, runner):
        ...
        with patch("deepr.cli.commands.run.asyncio.run") as mock_run:
            mock_run.return_value = None
            result = runner.invoke(cli, ["run", "focus", "test query", "--provider", "grok"])
    ...
    def test_provider_option_rejects_invalid(self, runner):
        ...
        result = runner.invoke(cli, ["run", "focus", "test query", "--provider", "invalid-provider"])
...
class TestModelValidation:
    ...
    def test_model_option_accepts_values(self, runner):
        ...
        with patch("deepr.cli.commands.run.asyncio.run") as mock_run:
            mock_run.return_value = None
            result = runner.invoke(cli, ["run", "focus", "test query", "--model", "o4-mini-deep-research"])
    ...
    def test_model_short_option_works(self, runner):
        ...
        with patch("deepr.cli.commands.run.asyncio.run") as mock_run:
            mock_run.return_value = None
            result = runner.invoke(cli, ["run", "focus", "test query", "-m", "o4-mini-deep-research"])

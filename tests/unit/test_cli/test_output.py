...
class TestOutputModeMutualExclusivity:
    ...
    @given(verbose=st.booleans(), json_output=st.booleans(), quiet=st.booleans())
...
class TestOperationResult:
    ...
    def test_error_result_to_json(self):
        ...
        result = OperationResult(
            success=False, duration_seconds=10.0, cost_usd=0.0, error="API rate limit exceeded", error_code="RATE_LIMIT"
        )
    ...
    def test_success_result_with_missing_optional_fields(self):
        ...
        result = OperationResult(success=True, duration_seconds=10.0, cost_usd=0.0)
    ...
    def test_error_result_with_missing_error_details(self):
        ...
        result = OperationResult(success=False, duration_seconds=5.0, cost_usd=0.0)
...
class TestOutputFormatterMinimalMode:
    ...
    def test_minimal_success_output_format(self, capsys):
        ...
        result = OperationResult(success=True, duration_seconds=135.0, cost_usd=0.42, report_path="reports/abc123")
    ...
    def test_minimal_error_output_format(self, capsys):
        ...
        result = OperationResult(success=False, duration_seconds=10.0, cost_usd=0.0, error="API rate limit exceeded")
    ...
    def test_minimal_path_ends_with_slash(self, capsys):
        ...
        result = OperationResult(success=True, duration_seconds=60.0, cost_usd=0.10, report_path="reports/test")
...
class TestMinimalOutputFormatProperty:
    ...
    def test_minimal_output_format_consistency(self, duration: float, cost: float, path: str, capsys):
        ...
        result = OperationResult(success=True, duration_seconds=duration, cost_usd=cost, report_path=path)
...
class TestOutputFormatterJSONMode:
    ...
    def test_json_success_output(self, capsys):
        ...
        result = OperationResult(
            success=True, duration_seconds=135.5, cost_usd=0.42, report_path="reports/abc123/", job_id="research-abc123"
        )
    ...
    def test_json_no_progress_output(self, capsys):
        ...
        result = OperationResult(success=True, duration_seconds=10.0, cost_usd=0.01, report_path="reports/test/")
...
class TestJSONOutputValidity:
    ...
    def test_json_output_always_valid(
        self, success: bool, duration: float, cost: float, path: str, job_id: str, error: str, error_code: str, capsys
    ):
...
class TestJSONOutputCompletenessSuccess:
    ...
    @settings(max_examples=100, suppress_health_check=[hypothesis.HealthCheck.function_scoped_fixture])
    def test_json_success_has_all_fields(self, duration: float, cost: float, path: str, job_id: str, capsys):
        """For any success result, JSON has all required fields."""
        context = OutputContext(mode=OutputMode.JSON)
        formatter = OutputFormatter(context)

        result = OperationResult(
            success=True, duration_seconds=duration, cost_usd=cost, report_path=path, job_id=job_id
        )
...
class TestJSONOutputCompletenessError:
    ...
    @settings(max_examples=100, suppress_health_check=[hypothesis.HealthCheck.function_scoped_fixture])
    def test_json_error_has_all_fields(self, duration: float, error: str, error_code: str, capsys):
        """For any error result, JSON has all required fields."""
        context = OutputContext(mode=OutputMode.JSON)
        formatter = OutputFormatter(context)

        result = OperationResult(
            success=False, duration_seconds=duration, cost_usd=0.0, error=error, error_code=error_code
        )
...
class TestOutputFormatterQuietMode:
    ...
    def test_quiet_success_no_stdout(self, capsys):
        ...
        result = OperationResult(success=True, duration_seconds=135.5, cost_usd=0.42, report_path="reports/abc123/")
...
class TestQuietModeStdoutSilence:
    ...
    @settings(max_examples=100, suppress_health_check=[hypothesis.HealthCheck.function_scoped_fixture])
    def test_quiet_success_stdout_empty(self, duration: float, cost: float, path: str, job_id: str, capsys):
...
class TestQuietModeStderrErrors:
    ...
    @given(
        duration=st.floats(min_value=0, max_value=86400, allow_nan=False, allow_infinity=False),
        error=st.text(
            min_size=1, max_size=200, alphabet="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 .,!?-_"
        ),
    )
    @settings(max_examples=100, suppress_health_check=[hypothesis.HealthCheck.function_scoped_fixture])
    def test_quiet_error_stderr_only(self, duration: float, error: str, capsys):
        ...
        result = OperationResult(success=False, duration_seconds=duration, cost_usd=0.0, error=error)
...
class TestExitCodeConsistency:
    ...
    @given(mode=st.sampled_from([OutputMode.MINIMAL, OutputMode.VERBOSE, OutputMode.JSON, OutputMode.QUIET]))

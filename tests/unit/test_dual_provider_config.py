...
def test_use_case_routing():
    ...
    print("Expert Chat                  xai       grok-4.3")
    print("Team Research                xai       grok-4.3")
    print("Planning/Synthesis           xai       grok-4.3")
    print("Context Summarization        xai       grok-4.3")
    print("Link Filtering (Scraping)    xai       grok-4.3")
    print("Document Processing          xai       grok-4.3")
...
def run_all_tests():
    ...
    try:
        ...
        print("- General Operations -> xAI (grok-4.3)")

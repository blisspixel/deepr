    ...
    def test_429_response_has_error_code_field(self, client):
        ...
        **Validates: Requirements 2.2**
        ...
        assert data['error_code'] == "RATE_LIMIT_EXCEEDED", \
            "error_code must be 'RATE_LIMIT_EXCEEDED'"
    ...
    **Validates: Requirements 2.3**
    ...
    def test_different_endpoints_have_independent_limits(self, client):
        ...
        **Validates: Requirements 2.3**
        ...
        response = client.get('/api/jobs/test-job-123')
        assert response.status_code == 200, \
            "Job status endpoint should have independent rate limit"
    ...
    **Validates: Requirements 2.3**
    ...
    def test_job_submit_limit_is_restrictive(self):
        ...
        **Validates: Requirements 2.3**
        ...
        assert submit_limit < status_limit, \
            "Job submit limit should be lower than status limit"
        assert submit_limit < listing_limit, \
            "Job submit limit should be lower than listing limit"

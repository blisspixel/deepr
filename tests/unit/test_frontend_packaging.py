...
def test_sdist_check_accepts_only_the_frontend_archive(tmp_path: Path):
    ...
    _write_sdist(
        sdist,
        (
            "deepr_research-2.50.7/pyproject.toml",
            "deepr_research-2.50.7/src/deepr/web/frontend/frontend-dist.zip",
        ),
    )
...
def test_sdist_check_rejects_frontend_dependency_files(tmp_path: Path):
    ...
    _write_sdist(
        ...
        (
            "deepr_research-2.50.7/src/deepr/web/frontend/frontend-dist.zip",
            "deepr_research-2.50.7/src/deepr/web/frontend/node_modules/pkg/tool.py",
        ),
    )
...
def test_sdist_check_rejects_duplicate_members(tmp_path: Path):
    sdist = tmp_path / "deepr.tar.gz"
    archive_name = "deepr_research-2.50.7/src/deepr/web/frontend/frontend-dist.zip"

...
class TestPropertyBased:
    ...
    @given(st.lists(st.text(alphabet="abcdefghijklmnopqrstuvwxyz0123456789_-.", min_size=1, max_size=20), min_size=1, max_size=10))
    @settings(max_examples=30)

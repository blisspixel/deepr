...
class TestWorldviewLoading:
    ...
    def test_worldview_loads_from_json(self):
        ...
        from deepr.experts.synthesis import Worldview, Belief, KnowledgeGap
        import tempfile
        import json
...
class TestResearchQueryConstruction:
    ...
    def test_query_from_single_question(self):
        ...
        gap = KnowledgeGap(
            topic="Testing",
            questions=["How to write unit tests?"],
            priority=3,
...
class TestGapRemovalAfterFilling:
    ...
    def test_filled_gaps_removed(self):
        ...
        from deepr.experts.synthesis import Worldview, KnowledgeGap
        ...
        worldview.knowledge_gaps = [
            g for g in worldview.knowledge_gaps

...
class TestOutputFlagsAvailable:
    ...
    def test_status_command_has_output_flags(self):
        ...
        result = subprocess.run(["deepr", "status", "--help"], capture_output=True, text=True)
    ...
    def test_get_command_has_output_flags(self):
        ...
        result = subprocess.run(["deepr", "get", "--help"], capture_output=True, text=True)
    ...
    def test_cancel_command_has_output_flags(self):
        ...
        result = subprocess.run(["deepr", "cancel", "--help"], capture_output=True, text=True)
...
class TestMutualExclusivity:
    ...
    def test_verbose_and_json_conflict(self):
        ...
        result = subprocess.run(["deepr", "status", "--verbose", "--json", "test-job"], capture_output=True, text=True)
    ...
    def test_verbose_and_quiet_conflict(self):
        ...
        result = subprocess.run(["deepr", "status", "--verbose", "--quiet", "test-job"], capture_output=True, text=True)
    ...
    def test_json_and_quiet_conflict(self):
        ...
        result = subprocess.run(["deepr", "status", "--json", "--quiet", "test-job"], capture_output=True, text=True)
...
class TestMinimalModeOutput:
    ...
    def test_list_minimal_mode_default(self):
        ...
        result = subprocess.run(["deepr", "list", "--limit", "1"], capture_output=True, text=True)
    ...
    def test_status_not_found_minimal(self):
        ...
        result = subprocess.run(["deepr", "status", "nonexistent-job-12345"], capture_output=True, text=True)
...
class TestVerboseModeOutput:
    ...
    def test_list_verbose_mode(self):
        ...
        result = subprocess.run(["deepr", "list", "--verbose", "--limit", "1"], capture_output=True, text=True)
...
class TestJSONModeOutput:
    ...
    def test_list_json_mode_valid_json(self):
        ...
        result = subprocess.run(["deepr", "list", "--json", "--limit", "5"], capture_output=True, text=True)
    ...
    def test_status_json_mode_not_found(self):
        ...
        result = subprocess.run(["deepr", "status", "--json", "nonexistent-job-12345"], capture_output=True, text=True)
...
class TestQuietModeOutput:
    ...
    def test_list_quiet_mode_no_output(self):
        ...
        result = subprocess.run(["deepr", "list", "--quiet", "--limit", "1"], capture_output=True, text=True)
    ...
    def test_status_quiet_mode_no_output(self):
        ...
        result = subprocess.run(["deepr", "status", "--quiet", "nonexistent-job"], capture_output=True, text=True)
...
class TestFlagAliases:
    ...
    def test_v_alias_for_verbose(self):
        ...
        result_short = subprocess.run(["deepr", "list", "-v", "--limit", "1"], capture_output=True, text=True)

        result_long = subprocess.run(["deepr", "list", "--verbose", "--limit", "1"], capture_output=True, text=True)
    ...
    def test_q_alias_for_quiet(self):
        ...
        result_short = subprocess.run(["deepr", "list", "-q", "--limit", "1"], capture_output=True, text=True)

        result_long = subprocess.run(["deepr", "list", "--quiet", "--limit", "1"], capture_output=True, text=True)
...
class TestEnvironmentVariable:
    ...
    def test_deepr_verbose_env_var(self):
        ...
        result = subprocess.run(["deepr", "list", "--limit", "1"], capture_output=True, text=True, env=env)
    ...
    def test_explicit_flag_overrides_env_var(self):
        ...
        result = subprocess.run(["deepr", "list", "--quiet", "--limit", "1"], capture_output=True, text=True, env=env)

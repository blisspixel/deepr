    ...
    **Validates: Requirements 9.1, 9.2**
    ...
    def test_api_docs_returns_200(self, app_client):
        ...
        **Validates: Requirements 9.2**
        ...
        assert response.status_code in [200, 302, 308], \
            f"Expected 200/302/308, got {response.status_code}"
    ...
    def test_api_docs_contains_swagger_ui(self, app_client):
        ...
        **Validates: Requirements 9.2**
        ...
        found_indicator = any(
            indicator.lower() in html_content.lower() 
            for indicator in swagger_indicators
        )
        
        assert found_indicator, \
            "Swagger UI page should contain swagger-related content"
    ...
    **Validates: Requirements 9.3**
    ...
    def test_job_detail_endpoint_documented(self, app_client):
        ...
        **Validates: Requirements 9.3**
        ...
        assert job_detail_path is not None, \
            "GET /api/jobs/{job_id} should be documented"
        assert 'get' in job_detail_path, \
            "GET method should be documented for job detail"
    ...
    def test_results_endpoint_documented(self, app_client):
        ...
        **Validates: Requirements 9.3**
        ...
        assert results_path is not None, \
            "GET /api/results/{job_id} should be documented"
    ...
    def test_cost_summary_endpoint_documented(self, app_client):
        ...
        **Validates: Requirements 9.3**
        ...
        assert cost_path is not None, \
            "GET /api/cost/summary should be documented"
    ...
    def test_stats_endpoint_documented(self, app_client):
        ...
        **Validates: Requirements 9.3**
        ...
        assert stats_path is not None, \
            "GET /api/jobs/stats should be documented"
    ...
    **Validates: Requirements 9.4**
    ...
    def test_rate_limit_mentioned_in_description(self, app_client):
        ...
        **Validates: Requirements 9.4**
        ...
        assert found_rate_limit, \
            "API description should mention rate limiting"
    ...
    def test_429_response_documented(self, app_client):
        ...
        **Validates: Requirements 9.4**
        ...
        assert found_429, \
            "At least one endpoint should document 429 response"
    ...
    def test_rate_limit_error_schema_defined(self, app_client):
        ...
        **Validates: Requirements 9.4**
        ...
        found_schema = any(
            ...
            for schema in rate_limit_schemas
        )
        
        assert found_schema, \
            "Rate limit error schema should be defined"
    ...
    **Validates: Requirements 9.3**
    ...
    def test_job_submit_request_schema_defined(self, app_client):
        ...
        **Validates: Requirements 9.3**
        ...
        found_schema = any(
            schema in definitions 
            for schema in submit_schemas
        )
        
        assert found_schema, \
            "Job submission request schema should be defined"
    ...
    **Validates: Requirements 9.1**
    ...
    def test_spec_has_swagger_version(self, app_client):
        ...
        **Validates: Requirements 9.1**
        ...
        assert has_version, \
            "OpenAPI spec must declare version (swagger or openapi field)"
    ...
    def test_spec_has_base_path_or_servers(self, app_client):
        ...
        **Validates: Requirements 9.1**
        ...
        assert has_base, \
            "OpenAPI spec should declare basePath or servers"
        ...
        **Validates: Requirements 9.3**
        ...
        for path_key, path_item in paths.items():
            ...
            assert has_operation, \
                f"Path {path_key} should have at least one HTTP method defined"
                ...
                if method in path_item:
                    ...
                    if isinstance(operation, dict):
                        assert 'responses' in operation, \
                            f"{method.upper()} {path_key} should have responses defined"

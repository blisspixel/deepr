...
class TestCampaignExecutionIntegration:
    ...
    def mock_job_store(self):
        ...
        def list_jobs(campaign_id=None):
            if campaign_id:
                return [j for j in store.jobs.values() if j.get("campaign_id") == campaign_id]
    ...
    def test_campaign_error_handling(self, campaign_config, mock_provider):
        ...
        mock_provider.submit_research = AsyncMock(side_effect=Exception("Provider error"))
    ...
    def test_campaign_results_aggregation(self, campaign_config):
        ...
        phase_results = {
            ...
            "Analysis": {"insights": ["Insight A", "Insight B"], "cost": 2.80, "duration_seconds": 90},
            "Synthesis": {
...
class TestCampaignExecutionEdgeCases:
    ...
    def test_empty_campaign(self):
        ...
        empty_config = {"name": "Empty Campaign", "phases": [], "total_budget": 0.0}
    ...
    def test_single_phase_campaign(self):
        ...
        single_phase_config = {
            ...
            "phases": [{"name": "Only Phase", "prompt": "Do research", "budget": 5.0}],
            "total_budget": 5.0,
        }
    ...
    def test_campaign_partial_completion(self):
        ...
        completion_pct = (campaign_state["completed_phases"] / campaign_state["total_phases"]) * 100

        assert completion_pct == pytest.approx(66.67, rel=0.01)

        # Get successful results
        successful_results = [p["result"] for p in campaign_state["phases"] if p["status"] == "completed"]

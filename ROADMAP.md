...
## Current Status (v2.33.1)

**v2.33.1 additions:** public REST, web, and webhook errors no longer expose exception-derived text; authenticated webhook payload parsing is separated from response construction; and local report storage rejects rewritten job identifiers while enforcing resolved-base containment before filesystem probes.

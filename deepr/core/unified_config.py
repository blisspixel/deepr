...
class UnifiedConfig:
    ...
    # Expert defaults
    expert_defaults: Dict[str, Any] = field(default_factory=lambda: {
    ...
    # Research defaults
    research_defaults: Dict[str, Any] = field(default_factory=lambda: {
        "max_rounds": 5,
        "default_budget": 1.0,
        "parallel_searches": 3
    })
    ...
    def _apply_dict(self, data: Dict[str, Any], source: str = "dict"):
        ...
        """
        simple_fields = [
            "default_provider", "default_model", "data_dir", "log_level"
        ]
    ...
    def to_dict(self, mask_keys: bool = True) -> Dict[str, Any]:
        ...
        return {
            ...
            "providers": {
                name: p.to_dict(mask_keys=mask_keys)

...
def apply_basic_styles(doc):
    style = safe_get_style(doc, STYLE_NORMAL)
    font = style.font
    font.name = "Aptos Body"
    font.size = Pt(12)
    heading_1_style = safe_get_style(doc, STYLE_HEADING_1)
    font = heading_1_style.font
    font.name = "Aptos Display"
    font.size = Pt(16)
    font.bold = True
    heading_2_style = safe_get_style(doc, STYLE_HEADING_2)
    ...
    heading_3_style = safe_get_style(doc, STYLE_HEADING_3)
    font = heading_3_style.font
    font.name = "Aptos Display"
    font.size = Pt(13)
    font.bold = True

    bullet_style = safe_get_style(doc, STYLE_BULLET)
    font = bullet_style.font
    font.name = "Aptos Body"
    font.size = Pt(12)
    blockquote_style = safe_get_style(doc, STYLE_BLOCKQUOTE)

...
class APIServerError(CurriculumGenerationError):
    ...
    def __init__(self, status_code: int, message: str):
        ...
        super().__init__(
            ...
            f"This is an issue with the OpenAI API. Try again in a few minutes."
        )
...
class InvalidCurriculumError(CurriculumGenerationError):
    ...
    def __init__(self, issues: List[str]):
        ...
        issues_str = '\n  - '.join(issues)
        super().__init__(
            f"Invalid curriculum structure. Issues found:\n  - {issues_str}"
        )
...
class NetworkError(CurriculumGenerationError):
    ...
    def __init__(self):
        super().__init__(
            "Cannot reach OpenAI API. Check your internet connection and try again."
        )

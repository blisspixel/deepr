...
MODEL_CAPABILITIES: Dict[str, ModelCapability] = {
    ...
    "openai/gpt-5.2": ModelCapability(
        ...
        weaknesses=["Higher cost than gpt-4o", "Overkill for simple queries"],
    ...
    "gemini/gemini-2.5-flash": ModelCapability(
        ...
        strengths=["Very cheap ($0.002)", "Fast responses", "Good for general queries"],
        weaknesses=["Lower quality than premium models", "Not ideal for complex reasoning"],
    ...
    "anthropic/claude-sonnet-4-5": ModelCapability(
        ...
        weaknesses=["Less capable than Opus for complex research", "No native deep research API"],
    ...
    "anthropic/claude-haiku-4-5": ModelCapability(
        ...
        weaknesses=["No Extended Thinking support", "Not suitable for deep research", "Less capable reasoning"],

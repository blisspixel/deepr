...
| `deepr-graph-commit-apply-v1` | [graph-commit-apply-v1.json](graph-commit-apply-v1.json) | Explicit apply result for idempotent commit writes into the canonical belief, event, edge, metacognition, exploration-agenda, hypothesis, concept, and stance stores |

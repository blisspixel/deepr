...
| `deepr-hallucination-risk-report-v1` | [hallucination-risk-report-v1.json](hallucination-risk-report-v1.json) | Read-only advisory hallucination-pattern risk signals across consult, handoff, and source-pack artifacts for regression selection and review routing |

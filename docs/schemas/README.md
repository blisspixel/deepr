...
| `deepr-expert-value-source-index-v1` | [expert-value-source-index-v1.json](expert-value-source-index-v1.json) | Experimental preparation chain binding world identities and cutoffs to exact local manifest bytes |
| `deepr-expert-value-source-world-v1` | [expert-value-source-world-v1.json](expert-value-source-world-v1.json) | Experimental bounded source inventory with explicit clock basis, source versions, byte sizes, hashes, declared availability, and separate snapshot collection time |
| `deepr-expert-value-source-preflight-v1` | [expert-value-source-preflight-v1.json](expert-value-source-preflight-v1.json) | Read-only nested integrity inspection that denies execution authority, semantic quality, verified historical availability, process isolation, and review blinding |
| `deepr-expert-value-source-copy-v1` | [expert-value-source-copy-v1.json](expert-value-source-copy-v1.json) | Read-only selected-world comparison of exact copied files and metadata; rejects extra, incomplete, altered or linked inputs without claiming process confinement or reviewed quality |
...
| `deepr-structured-consult-brief-v1` | [structured-consult-brief-v1.json](structured-consult-brief-v1.json) | Immutable eval-only local graph, frozen expert snapshots, exact dependencies, and aggregate zero-dollar resource authority |
| `deepr-structured-consult-position-v1` | [structured-consult-position-v1.json](structured-consult-position-v1.json) | One independent question-specific local expert position with evidence, assumptions, uncertainty, alternatives, and disconfirming tests |
| `deepr-structured-consult-synthesis-v1` | [structured-consult-synthesis-v1.json](structured-consult-synthesis-v1.json) | Require-all local synthesis over completed position artifacts with preserved agreements, dissent, uncertainty, and next tests |
| `deepr-structured-consult-run-v1` | [structured-consult-run-v1.json](structured-consult-run-v1.json) | Exact node completion, bounded local resource usage, typed stops, and hard `$0` metered authority for one eval-only graph run |
...
| `deepr-investigation-input-bundle-v1` | [investigation-input-bundle-v1.json](investigation-input-bundle-v1.json) | Root-confined, hashed inline, URL, file, and folder input manifest compiled without network access |
| `deepr-investigation-plan-v1` | [investigation-plan-v1.json](investigation-plan-v1.json) | Immutable local investigation plan with frozen expert snapshots and one exact aggregate capacity envelope |
| `deepr-investigation-charter-v1` | [investigation-charter-v1.json](investigation-charter-v1.json) | Per-expert independent research charter with bounded queries and declared evidence needs |
| `deepr-investigation-position-v1` | [investigation-position-v1.json](investigation-position-v1.json) | Independent or privately revised expert position with typed source lineage, uncertainty, and cruxes |
| `deepr-investigation-discussion-v1` | [investigation-discussion-v1.json](investigation-discussion-v1.json) | One blinded targeted challenge response that preserves peer lineage without granting evidence authority |
| `deepr-investigation-check-v1` | [investigation-check-v1.json](investigation-check-v1.json) | Separate model-generated support and contradiction check with truthful non-human review labels |
| `deepr-investigation-result-v1` | [investigation-result-v1.json](investigation-result-v1.json) | Evidence-linked synthesis with exact roster coverage, preserved dissent, and explicitly unreviewed semantic quality |
...
| `deepr-investigation-capability-snapshot-v1` | [investigation-capability-snapshot-v1.json](investigation-capability-snapshot-v1.json) | Derived run-start environment evidence that cannot create spend, tool, or memory authority |
| `deepr-investigation-control-evidence-v1` | [investigation-control-evidence-v1.json](investigation-control-evidence-v1.json) | Generated audit projection over plan, snapshot, journal, and control identities; not a canonical store |
| `deepr-investigation-status-projection-v1` | [investigation-status-projection-v1.json](investigation-status-projection-v1.json) | Read-only host observation of one run; cannot mutate the run or imply semantic acceptance |
| `deepr-investigation-event-page-v1` | [investigation-event-page-v1.json](investigation-event-page-v1.json) | Content-free, path-redacted event page with exclusive sequence cursor |
| `deepr-investigation-artifact-page-v1` | [investigation-artifact-page-v1.json](investigation-artifact-page-v1.json) | Metadata-only artifact page; hashes and taint only, no bodies or local paths |
| `deepr-investigation-follow-up-v1` | [investigation-follow-up-v1.json](investigation-follow-up-v1.json) | Preview-only follow-up lineage; does not start a run or grant capacity |
| `deepr-investigation-fork-lineage-v1` | [investigation-fork-lineage-v1.json](investigation-fork-lineage-v1.json) | Preview-only checkpoint fork lineage; does not create a child or edit the parent |
...
| `deepr-provider-billing-import-v1` | [provider-billing-import-v1.json](provider-billing-import-v1.json) | Bounded provider-neutral billing statement normalized offline without storing raw exports or secrets |
| `deepr-provider-billing-reconciliation-v1` | [provider-billing-reconciliation-v1.json](provider-billing-reconciliation-v1.json) | Exact receipt-linked comparison of provider charges and the canonical local cost ledger, with fail-closed freeze evidence |
| `deepr-paid-api-account-evidence-v1` | [paid-api-account-evidence-v1.json](paid-api-account-evidence-v1.json) | Content-addressed provider account-control observation that remains non-authoritative until an authenticated issuer and current credential identity resolver verify it |

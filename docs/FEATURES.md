...
add-belief, typed-edge, gap-promotion, exploration-agenda, hypothesis, and concept operations
...
verified concepts into the metacognition concept backlog. Local and non-metered plan claim compilation is `$0`

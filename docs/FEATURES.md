...
add-belief, typed-edge, gap-promotion, and exploration-agenda operations
...
adds verified exploration agendas into the metacognition agenda backlog. Local
and non-metered plan claim compilation is `$0`

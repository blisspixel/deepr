...
- Attended API grants are CLI-only, short-lived, and capped at $2 total. They
  never authorize MCP, schedules, loops, automatic fallback, or a model to
  widen its own spend authority.

...
2. Download `deepr-agent-plugin-2.50.15.tar.gz` from the
   ...
   `tar -xzf deepr-agent-plugin-2.50.15.tar.gz` or your archive utility.
...
python -m pip install ./deepr_research-2.50.15-py3-none-any.whl
deepr --version
```

...
2. Download `deepr-agent-plugin-2.50.17.tar.gz` from the
   [matching release](https://github.com/blisspixel/deepr/releases/tag/v2.50.17).
   Match the plugin version to the installed Deepr version and verify the
   asset checksum shown by GitHub. Extract it with
   `tar -xzf deepr-agent-plugin-2.50.17.tar.gz` or your archive utility.
...
python -m pip install ./deepr_research-2.50.17-py3-none-any.whl
deepr --version
```

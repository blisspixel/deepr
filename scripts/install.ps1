...
Write-Host "  3. Configure owned-local Ollama or a safety-eligible plan CLI"
Write-Host "  4. Keep the repository-wide ceiling at or below: $Cli budget set 5"
Write-Host ""
Write-Host "Quick start:"
Write-Host "  $Cli capacity"
Write-Host ""

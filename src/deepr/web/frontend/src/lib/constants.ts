export const MODELS = [
  { value: 'o4-mini-deep-research', label: 'o4-mini Deep Research', description: 'Faster deep research' },
  { value: 'o3-deep-research', label: 'o3 Deep Research', description: 'More thorough deep research' },
] as const

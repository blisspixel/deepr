...
def build_proposal_prompt(topic: str, known_terms: tuple[str, ...] = ()) -> str:
    ...
    return (
        ...
        "- Build a usable reference library, not a pile of search summaries. Seek authoritative "
        "full references, applicable versions, mechanisms and worked examples, then independent "
        "analysis of tradeoffs and failures. In the descriptive arm, prefer the original "
        "documentation or research over summaries that merely repeat it.\n"

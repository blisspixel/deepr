...
- [ ] `mypy --strict --no-warn-unused-ignores --ignore-missing-imports src/deepr/core src/deepr/providers src/deepr/mcp src/deepr/security`
...
- **Types**: `core/`, `providers/`, `mcp/`, and `security/` are `mypy --strict`-clean and
